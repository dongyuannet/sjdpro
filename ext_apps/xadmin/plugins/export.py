...
class ExportPlugin(BaseAdminPlugin):
    ...
    def get_xlsx_export(self, context):
        ...
        styles = {'datetime': book.add_format({'num_format': 'yyyy-mm-dd hh:mm:sjd'}),
                  'date': book.add_format({'num_format': 'yyyy-mm-dd'}),
                  'time': book.add_format({'num_format': 'hh:mm:sjd'}),
    ...
    def get_xls_export(self, context):
        ...
        sheet = book.add_sheet(
            u"%s %s" % (_(u'Sheet'), force_text(model_name)))
        styles = {'datetime': xlwt.easyxf(num_format_str='yyyy-mm-dd hh:mm:sjd'),
                  'date': xlwt.easyxf(num_format_str='yyyy-mm-dd'),
                  'time': xlwt.easyxf(num_format_str='hh:mm:sjd'),
